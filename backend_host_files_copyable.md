# Backend Host Files — copy into GitHub with exact paths

Create these files in your GitHub repo using the exact paths shown below.

## backend-host/package.json

```json
{
  "name": "levels-engine-v1-4-backend-host",
  "version": "1.0.0",
  "private": true,
  "type": "module",
  "description": "Standalone Express host for the v1.4 all-source overlap levels engine.",
  "engines": {
    "node": ">=20"
  },
  "scripts": {
...
## backend-host/exported-levels-engine/dist/index.js
